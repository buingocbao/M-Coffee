//
//  HotDrinkCollectionViewCell.swift
...
class HotDrinkCollectionViewCell: UICollectionViewCell {
    ...
    override func awakeFromNib() {
        ...
        placeholderLayer.contents = UIImage(named: "DefaultDrink")!.CGImage
    ...
    func nodeConstructionOperationWithDrinkInfo(drinkObject: PFObject, image: UIImage) -> NSOperation {
        ...
        nodeConstructionOperation.addExecutionBlock {
            ...
            if let strongSelf = self {
                ...
                titleTextNode.attributedString = NSAttributedString.attributedStringForTitleText(drinkObject["ProductName"] as! String)
